		...
		<div class="grid-x align-center">
			<div class="small-12 medium-7 medium-centered">
				...
				<form action="/sam_public/admin/users/create" method="post">
					...
					value="<?php echo e(\SAM\Classes\Request::old('post', 'fullname')); ?>">

					<input type="text" name="email" placeholder="Email Address"
					value="<?php echo e(\SAM\Classes\Request::old('post', 'email')); ?>">

					<input type="text" name="username" placeholder="Username"
					value="<?php echo e(\SAM\Classes\Request::old('post', 'username')); ?>">

					<input type="text" name="password" placeholder="Password"
					value="<?php echo e(\SAM\Classes\Request::old('post', 'password')); ?>">
					...
					<textarea name="address" placeholder="Your Address"><?php echo e(\SAM\Classes\Request::old('post', 'address')); ?></textarea>
