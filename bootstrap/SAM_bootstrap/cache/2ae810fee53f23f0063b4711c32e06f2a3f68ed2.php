				...
				<div class="grid-x grid-margin-x grid-margin-y">
					<div class="small-12 medium-6 cell">
						<label>Product name:
							...
							value="<?php echo e(\SAM\Classes\Request::old('post', 'name')); ?>">
						</label>
					</div>
					<div class="small-12 medium-6 cell">
						<label>Product price:
							<input type="text" name="price" placeholder="Product's Price" 
							value="<?php echo e(\SAM\Classes\Request::old('post', 'price')); ?>">
						</label>
					</div>
					...
					<div class="small-12 medium-6 cell">
						<label>Product Category:
							<select name="category" id="product-category">
								<option value="<?php echo e(\SAM\Classes\Request::old('post', 'category')?:""); ?>">
									<?php echo e(\SAM\Classes\Request::old('post', 'category')?:"Select Category"); ?>
					...
					<div class="small-12 medium-6 cell">
						<label>Product Subcategory:
							<select name="subcategory" id="product-subcategory">
								<option value="<?php echo e(\SAM\Classes\Request::old('post', 'subcategory')?:""); ?>">
									<?php echo e(\SAM\Classes\Request::old('post', 'subcategory')?:"Select Subcategory"); ?>
					...
					<div class="small-12 medium-6 cell">
						<label>Product Quantity:
							<select name="quantity">
								<option value="<?php echo e(\SAM\Classes\Request::old('post', 'quantity')?:""); ?>">
									<?php echo e(\SAM\Classes\Request::old('post', 'quantity')?:"Select quantity"); ?>
					...
					<div class="small-12 cell">
						<label>Description:
							<textarea name="description" placeholder="Description"><?php echo e(\SAM\Classes\Request::old('post', 'description')); ?></textarea>
						</label>
