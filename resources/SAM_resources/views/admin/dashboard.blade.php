		...
		<div class="grid-x grid-margin-x grid-margin-y" data-equilizer data-equalizer-on="medium">
				...
				<div class="card">
					...
					<div class="card-divider">
						<div class="grid-x cell">
							<a href="/sam_public/admin/orders">Order Details</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="small-12 medium-3 cell summary" data-equalizer-watch>
				<div class="card">
					...
					<div class="card-divider">
						<div class="grid-x cell">
							<a href="/sam_public/admin/products">View Products</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="small-12 medium-3 cell summary" data-equalizer-watch>
				<div class="card">
					...
					<div class="card-divider">
						<div class="grid-x cell">
							<a href="/sam_public/admin/payments">Payment Details</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="small-12 medium-3 cell summary" data-equalizer-watch>
				<div class="card">
					...
					<div class="card-divider">
						<div class="grid-x cell">
							<a href="/sam_public/admin/users/create">Register Users</a>
						</div>
					</div>
				</div>
			</div>
