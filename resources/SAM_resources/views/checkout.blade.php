                        ...
                        <div class="row"><!--row start -->
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                                    ...
                                    <input type="text" name="billing_first_name" class="form-control" value="{{_user()->firstname}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                                    <label> Last Name: </label>
                                    <input type="text" name="billing_last_name" class="form-control" value="{{_user()->lastname}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                                    <label> Address 1: </label>
                                    <input type="text" name="billing_address_1" class="form-control" value="{{_user()->address}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                            ...
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                                    <label> City: </label>
                                    <input type="text" name="billing_city" class="form-control" value="{{_user()->city}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                                    <label> State: </label>
                                    <input type="text" name="billing_state" class="form-control" value="{{_user()->state}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6"><!--col-sm-6 -->
                                <div class="form-group"><!--form-group start -->
                                    <label> Zipcode: </label>
                                    <input type="text" name="billing_zipcode" class="form-control" value="{{_user()->zipcode}}" required>
                                </div>
                            </div><!--col-sm-6 end-->
                        </div><!--row end -->
            ...
            <div class="col-md-4"><!--col-md-4 start-->
                <div class="box-summary" id="order-summary"><!--box start -->
                    ...
                    <div id="shopping_cart"> 
                        ...
                        {{-- if click on submit it will go to Order Complete page --}}
                            ...
                            <tbody id="checkout-tbody-reload"><!--checkout-tbody-reload start -->
                                ...
                                <tr>
                                    ...
                                    <th colspan="2">
                                        ...
                                        {{-- <input  @click.prevent="checkout" id="stripe-radio" type="radio" name="payment_method" value="stripe" checked> --}}
